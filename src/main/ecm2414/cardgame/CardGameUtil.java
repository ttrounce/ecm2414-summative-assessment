...
/**
 * Utilities used by the card game, such as a basic file output and conversion
 * functions.
 */
public class CardGameUtil
{
	...
	/**
	 * Opens a file at a path and writes a line. This function creates the file and
	 * any directories should they not exist.
	 * 
	...
	/**
	 * Clears a file at a path. This function creates the file and any directories
	...
	/**
	 * Converts a collection of Objects to a string where elements are separated by
	 * a space (" ").
	 * 
